...
INSERT INTO accounts (email, username) VALUES ('example_!@gmail.com', 'example_1');
...
accounts[0].id # =>  1
accounts[0].email # =>  'example_1@gmail.com'
accounts[0].username # =>  'example_1'

accounts[1].id # =>  2
accounts[1].name # =>  'example_2@gmail.com'
accounts[1].cohort_name # =>  'example_2'
...
account.id # =>  1
account.email # =>  'example_1@gmail.com'
account.username # =>  'example_1'
...
def reset_accounts_table
  ...
  connection = PG.connect({ host: '127.0.0.1', dbname: 'accounts_test' })
